...
const en = {
  ...
  auth: {
    ...
    accountExists: "Account already exists. Sign in.",
    signUpIncomplete:
      "We couldn't finish creating your account. Tap \"Use a different email\" and try again.",
...
const es = {
  ...
  auth: {
    ...
    signInSubtitle: "Inicia sesión para acceder a tus briefings de audio con IA.",
    signUpSubtitle: "Crea una cuenta para empezar tus briefings de audio con IA.",
    ...
    codeSubtitle: "Introduce el código que enviamos a",
    codeRequired: "El código de verificación es obligatorio.",
    codeInvalid: "Introduce el código de 6 dígitos de tu correo.",
    verify: "Verificar",
    resendCode: "Reenviar código",
    resendCooldown: "Reenviar código en {{seconds}} s",
    startOver: "Usar otro correo",
    codeSentAgain: "Te enviamos otro código a tu correo.",
    genericError: "Algo salió mal. Inténtalo de nuevo.",
    createAccountHint: "Introduce tu correo arriba para crear una cuenta.",
    accountNotFound: "No hay cuenta con ese correo. Crea una en su lugar.",
    accountExists: "Ese correo ya tiene una cuenta. Inicia sesión en su lugar.",
  },
};
...
const zh = {
  ...
  auth: {
    title: "登录",
    screenTitle: "欢迎",
    signInSubtitle: "登录以访问你的 AI 音频简报。",
    signUpSubtitle: "创建账户，开始你的 AI 音频简报。",
    tabSignIn: "登录",
    ...
    startOver: "使用其他邮箱",
    codeSentAgain: "我们已向你的邮箱发送了新的验证码。",
    genericError: "出了点问题，请重试。",
    createAccountHint: "在上方输入邮箱以创建账户。",
    accountNotFound: "未找到该邮箱对应的账户，请改为创建账户。",
    accountExists: "该邮箱已有账户，请改为登录。",
  },
};
...
const hi = {
  ...
  auth: {
    ...
    signInSubtitle: "अपने AI ऑडियो ब्रीफिंग तक पहुँचने के लिए साइन इन करें।",
    signUpSubtitle: "अपने AI ऑडियो ब्रीफिंग शुरू करने के लिए खाता बनाएँ।",
    tabSignIn: "साइन इन",
    tabCreateAccount: "खाता बनाएँ",
    email: "ईमेल पता",
    emailPlaceholder: "name@eilo.app",
    password: "पासवर्ड",
    passwordPlaceholder: "••••••••",
    ...
    code: "सत्यापन कोड",
    codeSubtitle: "वह कोड दर्ज करें जो हमने भेजा है",
    codeRequired: "सत्यापन कोड आवश्यक है।",
    codeInvalid: "अपने ईमेल का 6-अंकीय कोड दर्ज करें।",
    verify: "सत्यापित करें",
    resendCode: "कोड दोबारा भेजें",
    resendCooldown: "{{seconds}} सेकंड में कोड दोबारा भेजें",
    startOver: "दूसरा ईमेल उपयोग करें",
    codeSentAgain: "हमने आपके ईमेल पर एक और कोड भेजा है।",
    genericError: "कुछ गलत हो गया। कृपया पुनः प्रयास करें।",
    createAccountHint: "खाता बनाने के लिए ऊपर अपना ईमेल दर्ज करें।",
    accountNotFound: "इस ईमेल के लिए कोई खाता नहीं मिला। इसके बजाय खाता बनाएँ।",
    accountExists: "इस ईमेल का पहले से खाता है। इसके बजाय साइन इन करें।",
  },
};
...
const pt = {
  ...
  auth: {
    ...
    signInSubtitle: "Inicie sessão para aceder aos seus briefings de áudio com IA.",
    signUpSubtitle: "Crie uma conta para começar os seus briefings de áudio com IA.",
    tabSignIn: "Entrar",
    ...
    codeSubtitle: "Introduza o código que enviámos para",
    codeRequired: "O código de verificação é obrigatório.",
    codeInvalid: "Introduza o código de 6 dígitos do seu e-mail.",
    verify: "Verificar",
    resendCode: "Reenviar código",
    resendCooldown: "Reenviar código em {{seconds}} s",
    startOver: "Usar outro e-mail",
    codeSentAgain: "Enviámos outro código para o seu e-mail.",
    genericError: "Algo correu mal. Tente novamente.",
    createAccountHint: "Introduza o seu e-mail acima para criar uma conta.",
    accountNotFound: "Nenhuma conta encontrada para esse e-mail. Crie uma em vez disso.",
    accountExists: "Esse e-mail já tem uma conta. Inicie sessão em vez disso.",
  },
};
...
const fr = {
  ...
  auth: {
    ...
    signInSubtitle: "Connectez-vous pour accéder à vos briefings audio IA.",
    signUpSubtitle: "Créez un compte pour démarrer vos briefings audio IA.",
    tabSignIn: "Connexion",
    ...
    codeSubtitle: "Entrez le code que nous avons envoyé à",
    codeRequired: "Le code de vérification est obligatoire.",
    codeInvalid: "Entrez le code à 6 chiffres reçu par e-mail.",
    verify: "Vérifier",
    resendCode: "Renvoyer le code",
    resendCooldown: "Renvoyer le code dans {{seconds}} s",
    startOver: "Utiliser un autre e-mail",
    codeSentAgain: "Nous avons envoyé un autre code à votre e-mail.",
    genericError: "Une erreur s'est produite. Veuillez réessayer.",
    createAccountHint: "Entrez votre e-mail ci-dessus pour en créer un.",
    accountNotFound: "Aucun compte trouvé pour cet e-mail. Créez-en un à la place.",
    accountExists: "Cet e-mail a déjà un compte. Connectez-vous à la place.",
  },
};
...
const ar = {
  ...
  auth: {
    title: "تسجيل الدخول",
    screenTitle: "مرحبًا",
    signInSubtitle: "سجّل الدخول للوصول إلى ملخصاتك الصوتية بالذكاء الاصطناعي.",
    signUpSubtitle: "أنشئ حسابًا لبدء ملخصاتك الصوتية بالذكاء الاصطناعي.",
    ...
    card1Title: "ابقَ متقدمًا.",
    card1Description:
      "ملخصات ذكاء اصطناعي تحول البريد والأخبار إلى استماع هادئ.",
    card2Title: "استمع في أي مكان.",
    card2Description:
      "يومك ملخصًا في صوت يمكنك تشغيله أثناء التنقل.",
    back: "العودة إلى الرئيسية",
    emailRequired: "البريد الإلكتروني مطلوب.",
    emailInvalid: "أدخل عنوان بريد إلكتروني صالحًا.",
    code: "رمز التحقق",
    codeSubtitle: "أدخل الرمز الذي أرسلناه إلى",
    codeRequired: "رمز التحقق مطلوب.",
    codeInvalid: "أدخل الرمز المكوّن من 6 أرقام من بريدك.",
    verify: "تحقق",
    resendCode: "إعادة إرسال الرمز",
    resendCooldown: "إعادة إرسال الرمز خلال {{seconds}} ث",
    startOver: "استخدام بريد آخر",
    codeSentAgain: "أرسلنا رمزًا آخر إلى بريدك الإلكتروني.",
    genericError: "حدث خطأ ما. يرجى المحاولة مرة أخرى.",
    createAccountHint: "أدخل بريدك أعلاه لإنشاء حساب.",
    accountNotFound: "لم يتم العثور على حساب لهذا البريد. أنشئ حسابًا بدلًا من ذلك.",
    accountExists: "هذا البريد لديه حساب بالفعل. سجّل الدخول بدلًا من ذلك.",
  },
};
...
const ja = {
  ...
  auth: {
    title: "サインイン",
    screenTitle: "ようこそ",
    signInSubtitle: "AI音声ブリーフィングにアクセスするにはサインインしてください。",
    signUpSubtitle: "AI音声ブリーフィングを始めるにはアカウントを作成してください。",
    tabSignIn: "サインイン",
    ...
    code: "確認コード",
    codeSubtitle: "次の宛先に送信したコードを入力してください",
    codeRequired: "確認コードは必須です。",
    codeInvalid: "メールの6桁コードを入力してください。",
    verify: "確認",
    resendCode: "コードを再送信",
    resendCooldown: "{{seconds}}秒後に再送信できます",
    startOver: "別のメールを使用",
    codeSentAgain: "新しい確認コードをメールに送信しました。",
    genericError: "問題が発生しました。もう一度お試しください。",
    createAccountHint: "上にメールを入力してアカウントを作成してください。",
    accountNotFound: "そのメールのアカウントが見つかりません。代わりに作成してください。",
    accountExists: "そのメールは既にアカウントがあります。代わりにサインインしてください。",
  },
};
...
const de = {
  ...
  auth: {
    title: "Anmelden",
    screenTitle: "Willkommen",
    signInSubtitle: "Melde dich an, um auf deine KI-Audio-Briefings zuzugreifen.",
    signUpSubtitle: "Erstelle ein Konto, um deine KI-Audio-Briefings zu starten.",
    tabSignIn: "Anmelden",
    ...
    codeSubtitle: "Gib den Code ein, den wir gesendet haben an",
    codeRequired: "Bestätigungscode ist erforderlich.",
    codeInvalid: "Gib den 6-stelligen Code aus deiner E-Mail ein.",
    verify: "Bestätigen",
    resendCode: "Code erneut senden",
    resendCooldown: "Code in {{seconds}} s erneut senden",
    startOver: "Andere E-Mail verwenden",
    codeSentAgain: "Wir haben einen weiteren Code an deine E-Mail gesendet.",
    genericError: "Etwas ist schiefgelaufen. Bitte versuche es erneut.",
    createAccountHint: "Gib oben deine E-Mail ein, um ein Konto zu erstellen.",
    accountNotFound: "Kein Konto für diese E-Mail gefunden. Erstelle stattdessen eines.",
...
const id = {
  ...
  auth: {
    title: "Masuk",
    screenTitle: "Selamat datang",
    signInSubtitle: "Masuk untuk mengakses briefing audio AI Anda.",
    signUpSubtitle: "Buat akun untuk memulai briefing audio AI Anda.",
    tabSignIn: "Masuk",
    tabCreateAccount: "Buat akun",
    email: "Alamat email",
    ...
    codeSubtitle: "Masukkan kode yang kami kirim ke",
    codeRequired: "Kode verifikasi wajib diisi.",
    codeInvalid: "Masukkan kode 6 digit dari email Anda.",
    verify: "Verifikasi",
    resendCode: "Kirim ulang kode",
    resendCooldown: "Kirim ulang kode dalam {{seconds}} dtk",
    startOver: "Gunakan email lain",
    codeSentAgain: "Kami mengirim kode lain ke email Anda.",
    genericError: "Terjadi kesalahan. Silakan coba lagi.",
    createAccountHint: "Masukkan email Anda di atas untuk membuat akun.",
    accountNotFound: "Tidak ada akun untuk email tersebut. Buat akun saja.",
    accountExists: "Email tersebut sudah memiliki akun. Masuk saja.",
  },
};
...
const ms = {
  ...
  auth: {
    title: "Log masuk",
    screenTitle: "Selamat datang",
    signInSubtitle: "Log masuk untuk mengakses taklimat audio AI anda.",
    signUpSubtitle: "Cipta akaun untuk memulakan taklimat audio AI anda.",
    tabSignIn: "Log masuk",
    tabCreateAccount: "Cipta akaun",
    email: "Alamat e-mel",
    emailPlaceholder: "nama@eilo.app",
    ...
    submit: "Log masuk",
    createAccountSubmit: "Cipta akaun",
    ...
    code: "Kod pengesahan",
    codeSubtitle: "Masukkan kod yang kami hantar ke",
    codeRequired: "Kod pengesahan diperlukan.",
    codeInvalid: "Masukkan kod 6 digit daripada e-mel anda.",
    verify: "Sahkan",
    resendCode: "Hantar semula kod",
    resendCooldown: "Hantar semula kod dalam {{seconds}} saat",
    startOver: "Gunakan e-mel lain",
    codeSentAgain: "Kami telah menghantar kod lain ke e-mel anda.",
    genericError: "Sesuatu telah berlaku. Sila cuba lagi.",
    createAccountHint: "Masukkan e-mel anda di atas untuk mencipta akaun.",
    accountNotFound: "Tiada akaun untuk e-mel tersebut. Cipta akaun sebaliknya.",
    accountExists: "E-mel tersebut sudah mempunyai akaun. Log masuk sebaliknya.",
  },
};
